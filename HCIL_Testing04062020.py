...
def symantec_data():
    ...
    k = 'HCIL_SEPM_Computer_Status-27May2020.csv'

    ka = k.replace('.csv', '').split('-')[1]  # get the date from file
    kt = datetime.strptime(ka, '%d%B%Y')

    raw_dump_path = 'HCIL_SEPM_Computer_Status-27May2020.csv'
...
pfiles = ['10.117.22.38_29042020.csv']
    ...
    dcc.Tabs([
        dcc.Tab(label='Proxy Dashboard', children=[
            ...
            html.Div(children=html.Div(id='graphs'))
                ...
                style={'fontWeight': 'bold', 'width': '98%', 'margin-left': 10, 'margin-right': 10, 'max-width': 50000},
